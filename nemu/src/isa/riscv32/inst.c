...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */)               \
	...
	INSTPAT("0100000 ????? ????? 101 ????? 00100 11", srai, I, R(dest) = (int)src1 >> (int)imm);
	...
	INSTPAT("0000001 ????? ????? 001 ????? 01100 11", mulh, R, R(dest) = (int)((SEXT((long long)src1, 32) * SEXT((long long)src2, 32)) >> 32));
	...
	INSTPAT("0100000 ????? ????? 101 ????? 01100 11", sra, R, R(dest) = (int)src1 >> (int)src2);
